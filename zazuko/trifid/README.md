...
| config.file | string | `"instances/docker-sparql/config.yaml"` |  |
| dataset.baseUrl | string | `"https://ld.admin.ch/"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"ghcr.io/zazuko/trifid"` |  |
| image.tag | string | `""` |  |
...
| sparql.endpoint | string | `"https://lindas-cached.cluster.ldbar.ch/query"` |  |
| tolerations | list | `[]` |  |
| volumeMounts | list | `[]` |  |
| volumes | list | `[]` |  |
