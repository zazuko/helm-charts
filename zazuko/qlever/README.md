...
![Version: 0.0.3](https://img.shields.io/badge/Version-0.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: sha-06d562c](https://img.shields.io/badge/AppVersion-sha--06d562c-informational?style=flat-square)
...
| config.index.settings_json.num_triples_per_batch | int | `100000` |  |
...
| server.podSecurityContext.fsGroup | int | `1000` | fsGroup is the group ID to run the container as |
| server.podSecurityContext.runAsGroup | int | `1000` | runAsGroup is the group ID to run the container as |
| server.podSecurityContext.runAsNonRoot | bool | `true` | runAsNonRoot tells if the container should run as a non-root user |
| server.podSecurityContext.runAsUser | int | `1000` | runAsUser is the user ID to run the container as |
...
| server.securityContext.runAsUser | int | `1000` | runAsUser is the user ID to run the container as |
...
| ui.podSecurityContext.fsGroup | int | `1000` | fsGroup is the group ID to run the container as |
| ui.podSecurityContext.runAsGroup | int | `1000` | runAsGroup is the group ID to run the container as |
| ui.podSecurityContext.runAsNonRoot | bool | `true` | runAsNonRoot tells if the container should run as a non-root user |
| ui.podSecurityContext.runAsUser | int | `1000` | runAsUser is the user ID to run the container as |
...
| ui.securityContext.runAsUser | int | `1000` | runAsUser is the user ID to run the container as |
